package com.akhilfrancis.loans.controller;
...
import com.akhilfrancis.loans.dto.ErrorResponseDto;
import com.akhilfrancis.loans.dto.LoansContactInfoDto;
import com.akhilfrancis.loans.dto.LoansDto;
import com.akhilfrancis.loans.dto.ResponseDto;
...
//        LOGGER.debug("bank-correlation-id found: {}", correlationID);
        LOGGER.debug("Fetch Loan Details REST API start");
        LoansDto loansDto = iLoansService.fetchLoan(mobileNumber);
        LOGGER.debug("Fetch Loan Details REST API end");
